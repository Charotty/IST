...
6. [Вкладки (3 опорные)](#вкладки)
   - [График](#вкладка-график) — chart + подпанели Решение / Bundle
   - [Режим](#вкладка-режим) — отдельная вкладка
...
+-----------------------------------------------------------------------------+
|  ВКЛАДКИ: График | Режим | Задачи | Конфигурация |
|  +-------------------------------------------------------------------------+|
...
| **График** | подпанели: Решение · Bundle | OKX / IST chart; explain; manifest |
| **Режим** | — | `inference.regime_series`, `RegimeView` |
| **Задачи** | Pipeline · Журнал WFO · Практика | orchestration CLI; journal; paper + reconcile |
| **Конфигурация** | — | `config/symbols/<slug>.yaml`, acceptance |

Код обёрток: `chart_hub_view.py`, `jobs_hub_view.py`, `regime_view.py`. Верхний уровень: `main_window.py` (4 вкладки).
